...
class Faker::ChileRut
  ...
  def self.full_rut(min_rut: T.unsafe(nil), fixed: T.unsafe(nil), formatted: T.unsafe(nil)); end
...
class Faker::Lorem
  ...
  def self.questions(number: T.unsafe(nil), supplemental: T.unsafe(nil)); end
  ...
  def self.words(number: T.unsafe(nil), supplemental: T.unsafe(nil)); end
end
...
class Faker::LoremPixel
  def self._deprecated_image(size: T.unsafe(nil), is_gray: T.unsafe(nil), category: T.unsafe(nil), number: T.unsafe(nil), text: T.unsafe(nil), secure: T.unsafe(nil)); end
...
module Post::GeneratedAttributeMethods
  ...
  def body_previously_changed?(**options); end
  ...
  def saved_change_to_body?(**options); end
  ...
  def saved_change_to_title?(**options); end
  ...
  def saved_change_to_user_id?(**options); end
  ...
  def title_previously_changed?(**options); end
  ...
  def user_id_changed?(**options); end
  ...
  def user_id_previously_changed?(**options); end
