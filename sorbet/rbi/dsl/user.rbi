...
class User
  ...
  module GeneratedAssociationMethods
    ...
    def poll_ids=(ids); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :polls`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Poll::PrivateCollectionProxy) }
    def polls; end

    sig { params(value: T::Enumerable[::Poll]).void }
    def polls=(value); end
