...
module Bootsnap
  ...
  def self.setup(cache_dir:, development_mode: nil, load_path_cache: nil, ignore_directories: nil, compile_cache_iseq: nil, compile_cache_yaml: nil, compile_cache_json: nil); end
...
module Bootsnap::LoadPathCache
  ...
  def self.setup(cache_path:, development_mode:, ignore_directories:); end
