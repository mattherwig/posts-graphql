...
class DEBUGGER__::ThreadClient
  ...
  def show_src(frame_index: nil, update_line: nil, max_lines: nil, **options); end
...
class DEBUGGER__::LineBreakpoint < DEBUGGER__::Breakpoint
  ...
  def enable; end
  def hook_call; end
  def initialize(path, line, cond: nil, oneshot: nil, hook_call: nil, command: nil, skip_activate: nil); end
  def inspect; end
  def iseq; end
